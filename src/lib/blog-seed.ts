...
<p>Delivery is two charges. A delivery and setup fee that every order pays, and a distance surcharge for how far the truck drives, so each ZIP code carries its own — enter yours at checkout and you will see both before you book. Check the <a href="/service-area">service area pages</a> for local notes; a margarita machine rental to a surrounding town may need a different delivery window.</p>
