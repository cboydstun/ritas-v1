...
export default function StickyCallBar() {
  ...
  return (
    <div className="sm:hidden fixed bottom-0 inset-x-0 z-40 flex border-t border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-charcoal/95 backdrop-blur-sm">
      <a
