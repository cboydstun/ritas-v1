...
export default function HeroSection() {
  return (
    <div className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-light via-margarita/10 to-teal/20">
      {/* Decorative Elements */}
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-extrabold text-charcoal mb-6 tracking-tight">
            Fresh, Authentic
