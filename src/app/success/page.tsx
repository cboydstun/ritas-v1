        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-charcoal/70 dark:text-white/70 max-w-2xl mx-auto">
              Thank you for your order! We've received your rental request and will be in touch soon.
            </p>
          </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white/80 dark:bg-charcoal/30 rounded-xl p-6">
                  ...
                  <p className="text-charcoal/70 dark:text-white/70">
                    <span className="font-medium">Machine Type:</span> {machineType.charAt(0).toUpperCase() + machineType.slice(1)} Tank
                  </p>
                  {mixers.length > 0 && (
                    <div className="mt-2">
                      <p className="font-medium text-charcoal/70 dark:text-white/70">Selected Mixers:</p>
                ...
                <div className="bg-white/80 dark:bg-charcoal/30 rounded-xl p-6">
                  ...
                  <p className="text-charcoal/70 dark:text-white/70">
                    Our team will contact you before your delivery date to confirm the details.
                  </p>
                </div>
              </div>
            </div>
